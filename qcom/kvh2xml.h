...
*/
enum Key_Values_StreamRX {
    PCM_DEEP_BUFFER                 = 0xA1000001,   /**< @h2xmle_name {PCM_Deep_Buffer}*/
    ULTRASOUND_PLAYBACK             = 0xA1000002,   /**< @h2xmle_name {Ultrasound_Playback} @h2xmle_description {Ultrasound_Stream_Rx, this is for legacy upd to define the subgraph as stream}*/
    PCM_RX_LOOPBACK                 = 0xA1000003,   /**< @h2xmle_name {PCM_Rx_Loopback}*/
    SENSOR_RENDERER                 = 0xA1000004,   /**< @h2xmle_name {Sensor_Renderer} @h2xmle_description {Sensor_Renderer, this is added for new audio sensor renderer usecase}*/
...
enum Key_Values_DeviceRX {
    ...
    SPEAKER_TDM             = 0xA200000D,   /**< @h2xmle_name {Speaker_TDM} @h2xmle_description {Subgraph for TDM backend for speaker}*/
    SPEAKER_I2S             = 0xA200000E,   /**< @h2xmle_name {Speaker_I2S} @h2xmle_description {Subgraph for I2S backend for speaker}*/
    SOUNDDOSECOMPUTATION    = 0xA2000012,   /**< @h2xmle_name {SoundDoseComputation} @h2xmle_description {Sub-graph to calculate Sound Dose Mel values for each of the RX device for Sound Dose calculation.}*/
    HFP_RX                  = 0xA2000014,   /**< @h2xmle_name {HFP_RX} @h2xmle_description {two pairs of SCO links are needed, so need to add HFP RX device}*/
    USB_RX_IMMUTABLE        = 0xA2000015,   /**< @h2xmle_name {USB_RX_IMMUTABLE} @h2xmle_description {Subgraph for USB RX immutable playback}*/
};
...
enum Key_Values_DeviceTX {
    ...
    SPEAKERMIC_TDM  = 0xA3000011,   /**< @h2xmle_name {Speakermic_TDM} @h2xmle_description {Speaker mic device for TDM Backend.}*/
    SPEAKERMIC_I2S  = 0xA3000012,   /**< @h2xmle_name {Speakermic_I2S} @h2xmle_description {Speaker mic device for I2S Backend.}*/
    HFP_TX          = 0xA3000015,   /**< @h2xmle_name {HFP_TX} @h2xmle_description {two pairs of SCO links are needed, so need to add HFP TX}*/
};
...
*/
enum Key_Values_DevicePP_Rx {
    DEVICEPP_RX_DEFAULT                 = 0xAC000001,   /**< @h2xmle_name {DevicePP_Rx_Default} @h2xmle_description {Default PP}*/
    DEVICEPP_RX_AUDIO_MBDRC             = 0xAC000002,   /**< @h2xmle_name {Audio_MBDRC} @h2xmle_description {Audio Rx MBDRC PP }*/
    DEVICEPP_RX_VOIP_MBDRC              = 0xAC000003,   /**< @h2xmle_name {Voip_MBDRC} @h2xmle_description {Voip Rx MBDRC}*/
    DEVICEPP_RX_HFPSINK                 = 0xAC000004,   /**< @h2xmle_name {HFP_Sink} @h2xmle_description {HFP Sink}*/
    DEVICEPP_RX_VOICE_DEFAULT           = 0xAC000005,   /**< @h2xmle_name {DevicePP_RX_Voice_Default} @h2xmle_description {Voice call default}*/
    DEVICEPP_RX_ULTRASOUND_GENERATOR    = 0xAC000006,   /**< @h2xmle_name {DevicePP_RX_Ultrasound_Gen} @h2xmle_description {Ultrasound GEN}*/
    DEVICEPP_RX_VOICE_RVE               = 0xAC000007,   /**< @h2xmle_name {DevicePP_RX_Voice_RVE} @h2xmle_description {Voice call RVE}*/
    DEVICEPP_RX_HPCM                    = 0xAC000008,   /**< @h2xmle_name {DEVICEPP_RX_HPCM} @h2xmle_description {HPCM RX}*/
    DEVICEPP_RX_VOICE_Fluence_NN_NS     = 0xAC000009,   /**< @h2xmle_name {DEVICEPP_RX_VOICE_Fluence_NN_NS} @h2xmle_description {Voice Rx Fluence_NN_NS}*/
    DEVICEPP_RX_VOIP_Fluence_NN_NS      = 0xAC00000A,   /**< @h2xmle_name {DEVICEPP_RX_VOIP_Fluence_NN_NS} @h2xmle_description {VoIP Rx Fluence_NN_NS}*/
    DEVICEPP_RX_AUDIO_MSPP              = 0xAC00000B,   /**< @h2xmle_name {Audio_MSPP} @h2xmle_description {Audio Rx MSPP PP}*/
    DEVICEPP_RX_BTSINK                  = 0xAC00000C,   /**< @h2xmle_name {Device_PP_RX_BtSink} @h2xmle_description {BT Sink Device PP RX}*/
    DEVICEPP_RX_HAPTICS_GENERATOR       = 0xAC00000D,   /**< @h2xmle_name {Haptics_generator} @h2xmle_description {Haptics_gen}*/
};
...
*/
enum Key_Values_DevicePP_Tx {
    DEVICEPP_TX_FLUENCE_FFECNS                  = 0xAD000001,   /**< @h2xmle_name {Fluence_FFECNS} @h2xmle_description {Used in NLPI use-cases for VUI, ACD, SENSOR_PCM_DATA and ASR}*/
    DEVICEPP_TX_AUDIO_FLUENCE_SMECNS            = 0xAD000002,   /**< @h2xmle_name {Audio_Fluence_SMECNS} @h2xmle_description {Single Mic ECNS }*/
    DEVICEPP_TX_AUDIO_FLUENCE_ENDFIRE           = 0xAD000003,   /**< @h2xmle_name {Audio_Fluence_Endfire} @h2xmle_description {EndFire_ECNS - Typically used for dual mic capture scenarios}*/
    DEVICEPP_TX_AUDIO_FLUENCE_PRO               = 0xAD000004,   /**< @h2xmle_name {Audio_Fluence_Pro} @h2xmle_description {Audio Multi MIC scenarios ; at least 3 or more Micss}*/
    DEVICEPP_TX_VOIP_FLUENCE_PRO                = 0xAD000005,   /**< @h2xmle_name {Voip_Fluence_Pro} @h2xmle_description {Voip Multi MIC scenarios ; at least 3 or more Micss}*/
    DEVICEPP_TX_HFP_SINK_FLUENCE_SMECNS         = 0xAD000006,   /**< @h2xmle_name {HFP_Sink_Fluence_SMECNS} @h2xmle_description {HFP Sink Single Mic ECNS }*/
    DEVICEPP_TX_VOIP_FLUENCE_SMECNS             = 0xAD000007,   /**< @h2xmle_name {Voip_Fluence_SMECNS} @h2xmle_description {Voip SMECNS scenarios ;1 mic}*/
    DEVICEPP_TX_VOICE_FLUENCE_SMECNS            = 0xAD000008,   /**< @h2xmle_name {Voice_Fluence_SMECNS} @h2xmle_description {Single Mic ECNS in voice call}*/
    DEVICEPP_TX_VOICE_FLUENCE_ENDFIRE           = 0xAD000009,   /**< @h2xmle_name {Voice_Fluence_Endfire} @h2xmle_description {EndFire_ECNS - Typically used for dual mic capture scenarios in voice call}*/
    DEVICEPP_TX_VOICE_FLUENCE_PRO               = 0xAD00000A,   /**< @h2xmle_name {Voice_Fluence_Pro} @h2xmle_description {Multi MIC scenarios ; at least 3 or more Micss in a voice call}*/
    DEVICEPP_TX_FLUENCE_FFNS                    = 0xAD00000B,   /**< @h2xmle_name {Fluence_FFNS} @h2xmle_description {Used in LPI use-cases for VUI, SENSOR_PCM_DATA}*/
    DEVICEPP_TX_RAW_LPI                         = 0xAD00000C,   /**< @h2xmle_name {RAW_LPI} @h2xmle_description {Used in LPI use-cases for 3rd party wakeup module in VUI and SENSOR_PCM_DATA}*/
    DEVICEPP_TX_VOIP_FLUENCE_ENDFIRE            = 0xAD00000D,   /**< @h2xmle_name {Voip_Fluence_Endfire} @h2xmle_description {Voip Endfire scenarios ;2 mic}*/
    DEVICEPP_TX_RAW_NLPI                        = 0xAD00000E,   /**< @h2xmle_name {RAW_NLPI} @h2xmle_description {Used in NLPI use-cases for 3rd party wakeup module}*/
    DEVICEPP_TX_VOICE_FLUENCE_NN                = 0xAD00000F,   /**< @h2xmle_name {Voice_Fluence_NN} @h2xmle_description {Fluence NN in voice call ; single and dual mic}*/
    DEVICEPP_TX_VOIP_FLUENCE_NN                 = 0xAD000010,   /**< @h2xmle_name {Voip_Fluence_NN} @h2xmle_description {Fluence NN in Voip call ; single and dual mic}*/
    DEVICEPP_TX_ULTRASOUND_DETECTOR             = 0xAD000011,   /**< @h2xmle_name {Ultrasound_Engine} @h2xmle_description {Used in Ultrasound Engine use-cases}*/
    DEVICEPP_TX_FLUENCE_FFEC                    = 0xAD000012,   /**< @h2xmle_name {Fluence_FFEC} @h2xmle_description {Used in NLPI use-cases for SENSOR_PCM_DATA}*/
    DEVICEPP_TX_VOICE_FLUENCE_ENDFIRE_RVE       = 0xAD000013,   /**< @h2xmle_name {Voice_Fluence_Endfire_RVE} @h2xmle_description {EndFire_ECNS - Typically used for dual mic capture scenarios in voice call}*/
    DEVICEPP_TX_HPCM                            = 0xAD000014,   /**< @h2xmle_name {DEVICEPP_TX_HPCM} @h2xmle_description {HPCM TX}*/
    DEVICEPP_TX_HFP_SINK_FLUENCE_ENDFIRE        = 0xAD000015,   /**< @h2xmle_name {HFP_Sink_Fluence_ENDFIRE} @h2xmle_description {EndFire_ECNS - Typically used for dual mic capture scenarios in BT HFP client voice call}*/
    DEVICEPP_TX_AUDIO_FLUENCE_NN                = 0xAD000016,   /**< @h2xmle_name {Audio_Fluence_NN} @h2xmle_description {Fluence NN in Audio Record ; single and dual mic}*/
    DEVICEPP_TX_VOICE_RECOGNITION               = 0xAD000017,   /**< @h2xmle_name {Voice_Recognition} @h2xmle_description {Voice_Recognition - Specifically used for voice recognition}*/
    DEVICEPP_TX_HFP_SINK_FLUENCE_NN_SM          = 0xAD000018,   /**< @h2xmle_name {HFP_Sink_Fluence_NN_SM} @h2xmle_description {Single Mic fluence NN in HFP Sink}*/
    DEVICEPP_TX_AAD                             = 0xAD000019,   /**< @h2xmle_name {AAD} @h2xmle_description {Used in LPI use-cases for ACD}*/
    DEVICEPP_TX_FLUENCE_FFNS_AAD                = 0xAD00001A,   /**< @h2xmle_name {Fluence_FFNS_AAD} @h2xmle_description {Used in LPI use-cases for VUI, SENSOR_PCM_DATA}*/
    DEVICEPP_TX_RAW_LPI_AAD                     = 0xAD00001B,   /**< @h2xmle_name {RAW_LPI_AAD} @h2xmle_description {Used in LPI use-cases for 3rd party wakeup module in VUI, SENSOR_PCM_DATA and ASR}*/
    DEVICEPP_TX_VOICE_FLUENCE_NN_DM             = 0xAD00001C,   /**< @h2xmle_name {Voice_Fluence_NN_DM} @h2xmle_description {Dual Mic fluence NN in voice call}*/
    DEVICEPP_TX_HFP_SINK_FLUENCE_NN_DM          = 0xAD00001D,   /**< @h2xmle_name {HFP_Sink_Fluence_NN_DM} @h2xmle_description {Dual Mic fluence NN in HFP Sink}*/
    DEVICEPP_TX_AUDIO_FLUENCE_NN_DM             = 0xAD00001E,   /**< @h2xmle_name {Audio_Fluence_NN_DM} @h2xmle_description {Dual Mic fluence NN in Audio Record}*/
    DEVICEPP_TX_VOICE_FLUENCE_ENDFIRE_FNN_NS    = 0xAD00001F,   /**< @h2xmle_name {Voice_Fluence_Endfire_FNN} @h2xmle_description {Endfire_FNN in voice call}*/
    DEVICEPP_TX_VOICE_FLUENCE_PRO_FNN_NS        = 0xAD000020,   /**< @h2xmle_name {Voice_Fluence_Pro_FNN} @h2xmle_description {Pro_FNN in voice call}*/
    DEVICEPP_TX_VOIP_FLUENCE_ENDFIRE_FNN_NS     = 0xAD000021,   /**< @h2xmle_name {Voip_Fluence_Endfire_FNN} @h2xmle_description {Endfire_FNN in voip call}*/
    DEVICEPP_TX_VOIP_FLUENCE_PRO_FNN_NS         = 0xAD000022,   /**< @h2xmle_name {Voip_Fluence_Pro_FNN} @h2xmle_description {Pro_FNN in voip call}*/
    DEVICEPP_TX_AUDIO_RECORD_ENQORE             = 0xAD000023,   /**< @h2xmle_name {Audio_Record_Enqore} @h2xmle_description {Enqore Audio Record}*/
    DEVICEPP_TX_VOICE_FLUENCE_NN_RVE            = 0xAD000024,   /**< @h2xmle_name {Voice_Fluence_NN_RVE} @h2xmle_description {Fluence NN in voice call ; single and dual mic}*/
    DEVICEPP_TX_CUSTOM_ECNS                     = 0xAD000025,   /**< @h2xmle_name {CUSTOM_ECNS} @h2xmle_description {Used in NLPI use-cases for VUI with custom config}*/
    DEVICEPP_TX_CUSTOM_NS                       = 0xAD000026,   /**< @h2xmle_name {CUSTOM_NS} @h2xmle_description {Used in LPI use-cases for VUI with custom config}*/
    DEVICEPP_TX_AUDIO_FLUENCE_SMECNS_EXT_EC     = 0xAD000027,   /**< @h2xmle_name {Audio_Fluence_SMECNS_EXT_EC} @h2xmle_description {Single Mic ECNS EXT_EC}*/
    DEVICEPP_TX_AUDIO_FLUENCE_ENDFIRE_EXT_EC    = 0xAD000028,   /**< @h2xmle_name {Audio_Fluence_Endfire_EXT_EC} @h2xmle_description {EndFire_ECNS EXT_EC - Typically used for dual mic capture scenarios}*/
    DEVICEPP_TX_AUDIO_FLUENCE_PRO_EXT_EC        = 0xAD000029,   /**< @h2xmle_name {Audio_Fluence_Pro_EXT_EC} @h2xmle_description {Audio Multi MIC EXT_EC scenarios ; at least 3 or more Micss}*/
    DEVICEPP_TX_VOIP_FLUENCE_SMECNS_EXT_EC      = 0xAD00002A,   /**< @h2xmle_name {Voip_Fluence_SMECNS_EXT_EC} @h2xmle_description {Voip SMECNS EXT_EC scenarios ;1 mic}*/
    DEVICEPP_TX_VOIP_FLUENCE_ENDFIRE_EXT_EC     = 0xAD00002B,   /**< @h2xmle_name {Voip_Fluence_Endfire_EXT_EC} @h2xmle_description {Voip Endfire EXT_EC scenarios ;2 mic}*/
    DEVICEPP_TX_VOIP_FLUENCE_PRO_EXT_EC         = 0xAD00002C,   /**< @h2xmle_name {Voip_Fluence_Pro_EXT_EC} @h2xmle_description {Voip Multi MIC EXT_EC scenarios ; at least 3 or more Micss}*/
    DEVICEPP_TX_VOICE_FLUENCE_SMECNS_EXT_EC     = 0xAD00002D,   /**< @h2xmle_name {Voice_Fluence_SMECNS_EXT_EC} @h2xmle_description {Single Mic ECNS EXT_EC in voice call}*/
    DEVICEPP_TX_VOICE_FLUENCE_ENDFIRE_EXT_EC    = 0xAD00002E,   /**< @h2xmle_name {Voice_Fluence_Endfire_EXT_EC} @h2xmle_description {EndFire_ECNS EXT_EC - Typically used for dual mic capture scenarios in voice call}*/
    DEVICEPP_TX_VOICE_FLUENCE_PRO_EXT_EC        = 0xAD00002F,   /**< @h2xmle_name {Voice_Fluence_Pro_EXT_EC} @h2xmle_description {Multi MIC EXT_EC scenarios ; at least 3 or more Micss in a voice call}*/
...
*/
enum Key_Values_MediaFmtID {
    MEDIA_FMT_PCM       = 0xAE000001,   /**< @h2xmle_name {PCM} @h2xmle_description {PCM Media format}*/
    MEDIA_FMT_AAC       = 0xAE000002,   /**< @h2xmle_name {AAC} @h2xmle_description {AAC Media format}*/
    MEDIA_FMT_ALAC      = 0xAE000003,   /**< @h2xmle_name {ALAC} @h2xmle_description {ALAC Media format}*/
    MEDIA_FMT_APE       = 0xAE000004,   /**< @h2xmle_name {APE} @h2xmle_description {APE Media format}*/
    MEDIA_FMT_WMAPRO    = 0xAE000005,   /**< @h2xmle_name {WMAPRO} @h2xmle_description {WMAPRO Media format}*/
    MEDIA_FMT_WMASTD    = 0xAE000006,   /**< @h2xmle_name {WMASTD} @h2xmle_description {WMASTD Media format}*/
    MEDIA_FMT_FLAC      = 0xAE000007,   /**< @h2xmle_name {FLAC} @h2xmle_description {FLAC Media format}*/
    MEDIA_FMT_VORBIS    = 0xAE000008,   /**< @h2xmle_name {VORBIS} @h2xmle_description {VORBIS Media format}*/
    MEDIA_FMT_MP3       = 0xAE000009,   /**< @h2xmle_name {MP3} @h2xmle_description {MP3 Media format}*/
    MEDIA_FMT_AMRWBPLUS = 0xAE00000A,   /**< @h2xmle_name {AMRWBPLUS} @h2xmle_description {AMRWBPLUS Media format}*/
    MEDIA_FMT_AMRWB     = 0xAE00000B,   /**< @h2xmle_name {AMRWB} @h2xmle_description {AMRWB Media format}*/
    MEDIA_FMT_AMRNB     = 0xAE00000C,   /**< @h2xmle_name {AMRNB} @h2xmle_description {AMRNB Media format}*/
    MEDIA_FMT_EVRC      = 0xAE00000D,   /**< @h2xmle_name {EVRC} @h2xmle_description {EVRC Media format}*/
    MEDIA_FMT_G711      = 0xAE00000E,   /**< @h2xmle_name {G711} @h2xmle_description {G711 Media format}*/
    MEDIA_FMT_QCELP     = 0xAE00000F,   /**< @h2xmle_name {QCELP} @h2xmle_description {QCELP Media format}*/
    MEDIA_FMT_OPUS      = 0xAE000010,   /**< @h2xmle_name {OPUS} @h2xmle_description {OPUS Media format}*/
};
...
*/
enum Key_Values_StreamPP_RX {
    STREAMPP_RX_DEFAULT = 0xAF000001,   /**< @h2xmle_name {StreamPP_Rx_Default} @h2xmle_description {Default PP Playback}*/
};
...
enum Key_Values_StreamTX {
    ...
    ULTRASOUND_CAPTURE          = 0xB1000013,   /**< @h2xmle_name {Ultrasound_Capture} @h2xmle_description {This is added to change the legacy ultrasound TX subgraph to stream type.}*/
    ASR                         = 0xB1000014,   /**< @h2xmle_name {ASR}*/
    CALL_TRANSLATION_TX         = 0xB1000015,   /**< @h2xmle_name {Call_Translation} @h2xmle_description {For Call Translation use case with Voice and VoIP.}*/
};
...
*/
enum Key_Values_VSID {
    VSID_DEFAULT    = 0xB3000001,   /**< @h2xmle_name {VSID_Default} @h2xmle_description {VSID default}*/
    VSID_VOICE1     = 0xB3000002,   /**< @h2xmle_name {VSID_Voice1} @h2xmle_description {VSID 0x11C05000}*/
    VSID_VOICE2     = 0xB3000003,   /**< @h2xmle_name {VSID_Voice2} @h2xmle_description {VSID 0x11DC5000}*/
    VSID_VOICE1_LB  = 0xB3000004,   /**< @h2xmle_name {VSID_Voice1_LB} @h2xmle_description {VSID 0x12006000}*/
    VSID_VOICE2_LB  = 0xB3000005,   /**< @h2xmle_name {VSID_Voice2_LB} @h2xmle_description {VSID 0x121C6000}*/
};
...
*/
enum Key_Values_BASS_BOOST_Switch {
...
*/
enum Key_Values_Virtualizer_Switch {
...
/**
    ...
    @range              {0xBA000001..0xBA00FFFF}
*/
enum Key_Values_SW_Sidetone {
...
*/
enum Key_Values_Stream_SlowTalk {
...
enum Key_Values_Stream_Config {
    ...
    STREAM_CFG_VUI_MMA      = 0xBC000008,   /**< @h2xmle_name {MMA} @h2xmle_description {stream config key value for VoiceUI MMA (multi modal detection) usecase}*/
    STREAM_CFG_ASR_QC       = 0xBC000009,   /**< @h2xmle_name {ASR_QC}*/
    STREAM_CFG_ASR_CUSTOM   = 0xBC00000A,   /**< @h2xmle_name {ASR_Custom}*/
    STREAM_CFG_SDZ_QC       = 0xBC00000B,   /**< @h2xmle_name {SDZ_QC}*/
    STREAM_CFG_HIST_CAP     = 0xBC00000C,   /**< @h2xmle_name {HIST_CAP}*/
};
...
*/
enum Key_Values_Stream_MuxDemux {
    ...
    TAG_VALUE_MUX_DEMUX_CONFIG_VOICE                    = 5,    /**< @h2xmle_name {Mux_Demux_Voice_Connection}*/
    TAG_VALUE_MUX_DEMUX_CONFIG_VOIP                     = 6,    /**< @h2xmle_name {Mux_Demux_VoIP_Connection}*/
};
...
/**
    ...
    @range              {0xD3000001..0xD300FFFF}
*/
enum Key_Values_Stream {
...
*/
enum Key_Values_StreamChannels {
...
*/
enum Key_Values_Input_Current_Limiter {
...
*/
enum Key_Values_Dtmf_Gen_KeyTone {
    DTMF_GEN_1  = 1,
    DTMF_GEN_2  = 2,
    DTMF_GEN_3  = 3,
    DTMF_GEN_4  = 4,
...
*/
enum Key_Values_HAPTICS_VI_Map {
...
*/
enum Key_Values_HAPTICS_Dev_Map {
...
*/
enum Key_Values_UltrasoundGain {
...
/**
    @h2xmlk_key         {MMA_MODEL_TYPE}
    @h2xmlk_description {Key for audio model type of MMA}
    @range              {0xE7030001..0xE703FFFF}
*/
...
enum Cal_Keys {
    ...
    ck_SP_Dev_Map                  = SPK_PRO_DEV_MAP,
    ck_SP_VI_Map                   = SPK_PRO_VI_MAP,
    ck_RAS_Switch                  = RAS_SWITCH,
    ck_Gain                        = GAIN,
    ck_StreamChannels              = STREAM_CHANNELS,
    ck_SP_CPS_Map                  = SPK_PRO_CPS_MAP,
    ck_HAPTICS_VI_Map              = HAPTICS_PRO_VI_MAP,
    ck_HAPTICS_Dev_Map             = HAPTICS_PRO_DEV_MAP,
    ck_USB_Vendor_Id               = USB_VENDOR_ID,
    ck_MMA_MODEL_TYPE              = MMA_MODEL_TYPE,
};
...
enum Tag_Definitions {
    ...
    DEVICE_HW_ENDPOINT_RX           = 0xC0000004, /**< @h2xmle_name {"device_hw_ep_rx"} */
    DEVICE_HW_ENDPOINT_TX           = 0xC0000005, /**< @h2xmle_name {"device_hw_ep_tx"} */
    TAG_PAUSE                       = 0xC0000006, /**< @h2xmle_name {"stream_pause"} */
    TAG_MUTE                        = 0xC0000007, /**< @h2xmle_name {"stream_mute"} */
    DEVICE_SVA                      = 0xC0000008, /**< @h2xmle_name {"device_sva"} */
    DEVICE_ADAM                     = 0xC0000009, /**< @h2xmle_name {"device_adam"} */
    TAG_ECNS                        = 0xC000000A, /**< @h2xmle_name {"device_ecns"} */
    TAG_STREAM_MFC                  = 0xC000000B, /**< @h2xmle_name {"stream_mfc"} */
    DEVICE_MFC                      = 0xC000000C, /**< @h2xmle_name {"device_mfc"} */
    TAG_STREAM_VOLUME               = 0xC000000D, /**< @h2xmle_name {"stream_volume"} */
    ...
    TAG_DEVICE_PP_MFC               = 0xC0000011, /**< @h2xmle_name {"device_pp_mfc"} */
    TAG_STREAM_PLACEHOLDER_DECODER  = 0xC0000012, /**< @h2xmle_name {"stream_placeholder_decoder"} */
    STREAM_SPR                      = 0xC0000013, /**< @h2xmle_name {"stream_spr"} */
    TAG_STREAM_EQUALIZER            = 0xC0000014, /**< @h2xmle_name {"stream_equalizer"} */
    TAG_STREAM_VIRTUALIZER          = 0xC0000015, /**< @h2xmle_name {"stream_virtualizer"} */
    TAG_STREAM_REVERB               = 0xC0000016, /**< @h2xmle_name {"stream_reverb"} */
    TAG_STREAM_PBE                  = 0xC0000017, /**< @h2xmle_name {"stream_pbe"} */
    TAG_STREAM_BASS_BOOST           = 0xC0000018, /**< @h2xmle_name {"stream_bass_bost"} */
    PER_STREAM_PER_DEVICE_MFC       = 0xC0000019, /**< @h2xmle_name {"pspd_mfc"} */
    ...
    TAG_STREAM_SLOW_TALK            = 0xC0000025, /**< @h2xmle_name {"stream_slowtalk"} */
    TAG_MODULE_CHANNELS             = 0xC0000026, /**< @h2xmle_name {"module_channels"} */
    TAG_STREAM_MUX_DEMUX            = 0xC0000027, /**< @h2xmle_name {"stream_muxdemux"} */
    ...
    TAG_DEVICE_PP_MBDRC             = 0xC000002B, /**< @h2xmle_name {"device_pp_mbdrc"} */
    WR_SHMEM_ENDPOINT               = 0xC000002C, /**< @h2xmle_name {"wr_sh_ep"} */
    TAG_STREAM_PLACEHOLDER_ENCODER  = 0xC000002D, /**< @h2xmle_name {"stream_placeholder_encoder"} */
    ...
    TAG_DEVICE_AL                   = 0xC0000033, /**< @h2xmle_name {"device_al"} */
    TAG_ASPHERE                     = 0xC0000034, /**< @h2xmle_name {"audio_sphere"} */
    TAG_DEV_MUTE                    = 0xC0000035, /**< @h2xmle_name {"device_mute"} */
    TAG_DATA_LOGGING                = 0xC0000036, /**< @h2xmle_name {"data_logging"} */
    DTMF_GENERATOR                  = 0xC0000037, /**< @h2xmle_name {"dtmf_generator"} */
    DTMF_DETECTOR                   = 0xC0000038, /**< @h2xmle_name {"dtmf_detector"} */
    TAG_MFC_SPEAKER_SWAP            = 0xC0000039, /**< @h2xmle_name {"mfc_speaker_swap"} */
    DEVICE_POP_SUPPRESSOR           = 0xC000003A, /**< @h2xmle_name {"device_pop_suppressor"} */
    TAG_DEVICEPP_EC_MFC             = 0xC000003B, /**< @h2xmle_name {"devicepp_ec_mfc"} */
    TAG_DUTY_CYCLE                  = 0xC000003C, /**< @h2xmle_name {"duty_cycle"} */
    ...
    TAG_DEVICE_MUX                  = 0xC0000040, /**< @h2xmle_name {"device_mux"} */
    TAG_DEVPP_MUTE                  = 0xC0000041, /**< @h2xmle_name {"devicepp_mute"} */
    TAG_ORIENTATION                 = 0xC0000042, /**< @h2xmle_name {"orientation"} */
    ...
    TAG_MFC_SIDETONE                = 0xC000004A, /**< @h2xmle_name {"mfc_sidetone"} */
    TAG_MODULE_TSM                  = 0xC000004B, /**< @h2xmle_name {"module_tsm"} */
    TAG_ULTRASOUND_GAIN             = 0xC000004C, /**< @h2xmle_name {"ultrasound_gain"} */
    TAG_AMS_SW_RD_EP_1              = 0xC000004D, /**< @h2xmle_name {"ams_sw_rd_ep_1"} @h2xmle_description {tagged module can be used as shared memory endpoint in AMS} */
    TAG_AMS_SW_RD_EP_2              = 0xC000004E, /**< @h2xmle_name {"ams_sw_rd_ep_2"} @h2xmle_description {tagged module can be used as shared memory endpoint in AMS} */
    TAG_AMS_SW_RD_EP_3              = 0xC000004F, /**< @h2xmle_name {"ams_sw_rd_ep_3"} @h2xmle_description {tagged module can be used as shared memory endpoint in AMS} */
...
/**
    @h2xmlk_modTagEnum {"device_hw_ep_rx", DEVICE_HW_ENDPOINT_RX}
    @h2xmlk_description {Hw EP Rx}
*/
enum Tag_Keys_DEVICE_HW_ENDPOINT_RX {
    tk1_device_hw_ep_rx = CHANNELS,
};


/**
    @h2xmlk_modTagEnum {"device_hw_ep_tx", DEVICE_HW_ENDPOINT_TX}
    @h2xmlk_description {Hw EP Tx}
*/
enum Tag_Keys_DEVICE_HW_ENDPOINT_TX {
    tk1_device_hw_ep_tx = CHANNELS,
};


/**
    @h2xmlk_modTagEnum {"stream_pause", TAG_PAUSE}
    @h2xmlk_description {Stream Pause}
*/
enum Tag_Keys_TAG_PAUSE {
    tk1_stream_pause = PAUSE,
};


/**
    @h2xmlk_modTagEnum {"stream_mute", TAG_MUTE}
    @h2xmlk_description {Stream Mute}
*/
enum Tag_Keys_TAG_MUTE {
    tk1_stream_mute = MUTE,
};


/**
    @h2xmlk_modTagEnum {"device_ecns", TAG_ECNS}
    @h2xmlk_description {Ecns On/Off}
*/
enum Tag_Keys_TAG_ECNS {
    tk1_device_ecns = ECNS,
};


/**
    @h2xmlk_modTagEnum {"stream_mfc", TAG_STREAM_MFC}
    @h2xmlk_description {Stream MFC}
*/
enum Tag_Keys_TAG_STREAM_MFC {
    tk1_stream_mfc = SAMPLINGRATE,
    tk2_stream_mfc = BITWIDTH,
    tk3_stream_mfc = CHANNELS,
};


/**
    @h2xmle_isVoice {true}
    @h2xmlk_modTagEnum {"stream_volume", TAG_STREAM_VOLUME}
    @h2xmlk_description {Stream Volume}
*/
enum Tag_Keys_TAG_STREAM_VOLUME {
    tk1_stream_volume = VOLUME,
};


/**
    @h2xmlk_modTagEnum {"device_pp_mfc", TAG_DEVICE_PP_MFC}
    @h2xmlk_description {Device PP MFC}
*/
enum Tag_Keys_TAG_DEVICE_PP_MFC {
...
/**
    @h2xmlk_modTagEnum {"stream_placeholder_decoder", TAG_STREAM_PLACEHOLDER_DECODER}
    @h2xmlk_description {Placeholder Decoder}
*/
enum Tag_Keys_TAG_STREAM_PLACEHOLDER_DECODER {
    tk1_stream_placeholder_decoder = MEDIA_FMT_ID,
};


/**
    @h2xmlk_modTagEnum {"stream_equalizer", TAG_STREAM_EQUALIZER}
    @h2xmlk_description {Stream Equalizer}
*/
enum Tag_Keys_TAG_STREAM_EQUALIZER {
    tk1_stream_equalizer = EQUALIZER_SWITCH,
};


/**
    @h2xmlk_modTagEnum {"stream_virtualizer", TAG_STREAM_VIRTUALIZER}
    @h2xmlk_description {Stream Virtualizer}
*/
enum Tag_Keys_TAG_STREAM_VIRTUALIZER {
    tk1_stream_virtualizer = VIRTUALIZER_SWITCH,
};


/**
    @h2xmlk_modTagEnum {"stream_reverb", TAG_STREAM_REVERB}
    @h2xmlk_description {Stream Reverb}
*/
enum Tag_Keys_TAG_STREAM_REVERB {
    tk1_stream_reverb = REVERB_SWITCH,
};


/**
    @h2xmlk_modTagEnum {"stream_pbe", TAG_STREAM_PBE}
    @h2xmlk_description {Stream PBE}
*/
enum Tag_Keys_TAG_STREAM_PBE {
    tk1_stream_pbe = PBE_SWITCH,
};


/**
    @h2xmlk_modTagEnum {"stream_bass_bost", TAG_STREAM_BASS_BOOST}
    @h2xmlk_description {Stream Bass Boost}
*/
enum Tag_Keys_TAG_STREAM_BASS_BOOST {
    tk1_stream_bass_bost = BASS_BOOST_SWITCH,
};


/**
    @h2xmlk_modTagEnum {"pspd_mfc", PER_STREAM_PER_DEVICE_MFC}
    @h2xmlk_description {Per Stream Per Device MFC}
*/
enum Tag_Keys_PER_STREAM_PER_DEVICE_MFC {
...
/**
    @h2xmlk_modTagEnum {"stream_slowtalk", TAG_STREAM_SLOW_TALK}
    @h2xmlk_description {Slow Talk}
*/
enum Tag_Keys_TAG_STREAM_SLOW_TALK {
    tk1_stream_slowtalk = TAG_KEY_SLOW_TALK,
};


/**
    @h2xmlk_modTagEnum {"module_channels", TAG_MODULE_CHANNELS}
    @h2xmlk_description {Module Channels}
*/
enum Tag_Keys_TAG_MODULE_CHANNELS {
    tk1_module_channels = CHANNELS,
};


/**
    @h2xmlk_modTagEnum {"stream_muxdemux", TAG_STREAM_MUX_DEMUX}
    @h2xmlk_description {Mux Demux}
*/
enum Tag_Keys_TAG_STREAM_MUX_DEMUX {
    tk1_stream_muxdemux = TAG_KEY_MUX_DEMUX_CONFIG,
};


/**
    @h2xmlk_modTagEnum {"device_pp_mbdrc", TAG_DEVICE_PP_MBDRC}
    @h2xmlk_description {Device PP Mbdrc}
*/
enum Tag_Keys_TAG_DEVICE_PP_MBDRC {
    tk1_device_pp_mbdrc = GAIN,
};


/**
    @h2xmlk_modTagEnum {"stream_placeholder_encoder", TAG_STREAM_PLACEHOLDER_ENCODER}
    @h2xmlk_description {Placeholder Encoder}
*/
enum Tag_Keys_TAG_STREAM_PLACEHOLDER_ENCODER {
    tk1_stream_placeholder_encoder = MEDIA_FMT_ID,
};


/**
    @h2xmlk_modTagEnum {"device_al", TAG_DEVICE_AL}
    @h2xmlk_description {Device AL}
*/
enum Tag_Keys_TAG_DEVICE_AL {
    tk1_device_al = ICL,
};


/**
    @h2xmlk_modTagEnum {"audio_sphere", TAG_ASPHERE}
    @h2xmlk_description {Sphere}
*/
enum Tag_Keys_TAG_ASPHERE {
    tk1_audio_sphere = ASPHERE_SWITCH,
};


/**
    @h2xmlk_modTagEnum {"device_mute", TAG_DEV_MUTE}
    @h2xmlk_description {Device Mute}
*/
enum Tag_Keys_TAG_DEV_MUTE {
    tk1_device_mute = MUTE,
};


/**
    @h2xmlk_modTagEnum {"data_logging", TAG_DATA_LOGGING}
    @h2xmlk_description {Data Logging}
*/
enum Tag_Keys_TAG_DATA_LOGGING {
    tk1_data_logging = LOGGING,
};


/**
    @h2xmlk_modTagEnum {"dtmf_generator", DTMF_GENERATOR}
    @h2xmlk_description {DTMF GENERATOR}
*/
enum Tag_Keys_DTMF_GENERATOR {
    tk1_dtmf_generator = TAG_KEY_DTMF_GEN_TONE,
};


/**
    @h2xmlk_modTagEnum {"dtmf_detector", DTMF_DETECTOR}
    @h2xmlk_description {DTMF DETECTOR}
*/
enum Tag_Keys_DTMF_DETECTOR {
    tk1_dtmf_detector = TAG_KEY_DTMF_SWITCH,
};


/**
    @h2xmlk_modTagEnum {"mfc_speaker_swap", TAG_MFC_SPEAKER_SWAP}
    @h2xmlk_description {MFC Speaker Swap}
*/
enum Tag_Keys_TAG_MFC_SPEAKER_SWAP {
...
/**
    @h2xmlk_modTagEnum {"devicepp_ec_mfc", TAG_DEVICEPP_EC_MFC}
    @h2xmlk_description {Devicepp EC MFC}
*/
enum Tag_Keys_TAG_DEVICEPP_EC_MFC {
    tk1_devicepp_ec_mfc = SAMPLINGRATE,
};


/**
    @h2xmlk_modTagEnum {"duty_cycle", TAG_DUTY_CYCLE}
    @h2xmlk_description {UPD duty cycle set}
*/
enum Tag_Keys_TAG_DUTY_CYCLE {
    tk1_duty_cycle = TAG_KEY_DUTY_CYCLE,
};


/**
    @h2xmlk_modTagEnum {"device_mux", TAG_DEVICE_MUX}
    @h2xmlk_description {Channel slot mask}
*/
enum Tag_Keys_TAG_DEVICE_MUX {
    tk1_device_mux = TAG_KEY_SLOT_MASK,
};


/**
    @h2xmlk_modTagEnum {"devicepp_mute", TAG_DEVPP_MUTE}
    @h2xmlk_description {DevicePP Mute}
*/
enum Tag_Keys_TAG_DEVPP_MUTE {
    tk1_devicepp_mute = MUTE,
};


/**
    @h2xmlk_modTagEnum {"orientation", TAG_ORIENTATION}
    @h2xmlk_description {orientation}
*/
enum Tag_Keys_TAG_ORIENTATION {
    tk1_orientation = TAG_KEY_ORIENTATION,
};


/**
    @h2xmlk_modTagEnum {"mfc_sidetone", TAG_MFC_SIDETONE}
    @h2xmlk_description {SIDETONE MFC}
*/
enum Tag_Keys_TAG_MFC_SIDETONE {
...
/**
    @h2xmlk_modTagEnum {"ultrasound_gain", TAG_ULTRASOUND_GAIN}
    @h2xmlk_description {Ultrasound Signal gain for different configuration}
*/
enum Tag_Keys_TAG_ULTRASOUND_GAIN {
